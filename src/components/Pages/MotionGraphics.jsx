...
export default function MotionGraphics() {
  pageTitle('Motion Graphics - StayWhizzy');
        ...
        <Div className="row">
          <Div className="col-lg-4">
            <IconBox
              ...
              subtitle='Creating unique and tailored motion graphics elements for videos or presentations.' 
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              subtitle='Developing animated content in both two-dimensional and three-dimensional formats.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              subtitle='Creating engaging and interactive animations for websites, apps, or presentations.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
        </Div>
