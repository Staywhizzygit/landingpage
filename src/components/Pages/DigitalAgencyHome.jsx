...
export default function DigitalAgencyHome() {
  ...
  pageTitle('StayWhizzy | Digital Agency');
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  const heroSocialLinks = [
    {
      name: 'Instagram',
      links: 'https://www.instagram.com/staywhizzy/',
    },
    {
      name: 'Facebook',
      links: 'https://www.facebook.com/profile.php?id=100093316497931',
    },
  ];
  const funfaceData = [
    {
  ...
  return (
    <>
      {/* Start Hero Section */}
      <Hero4
        title="We Are <span>Stay</span>Whizzy <br /> Digital Agency"
        subtitle="We deliver best problem solving solution for our client and provide top notch Digital Services in present and upcoming future."
        scrollDownId="#service"
        socialLinksHeading="Follow Us"
        heroSocialLinks={heroSocialLinks}
        phoneNumber="+91 6204206589"
        email="contact@staywhizzy.com"
      />
      {/* End Hero Section */}
        ...
        <Div className="container">
          <Div className="row">
            <Div className="col-lg-5 col-xl-4">
              <SectionHeading
                title="We are a leading Indian SMMA. Our highly skilled and adaptable team makes us the best in the business."
