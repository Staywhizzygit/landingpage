...
export default function ContentCreation() {
  pageTitle('Content Creation - StayWhizzy');
        ...
        <Div className="row">
          <Div className="col-lg-4">
            <IconBox
              ...
              subtitle='Tailored plans for client goals.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Content Creation'
              subtitle='Articles, videos, posts, etc.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
        ...
        <Div className="row">
          <Div className="col-lg-4">
            <IconBox
              ...
              subtitle='Engaging audience, growth.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              subtitle='Visual elements creation.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
